...
class Template {
    constructor(results) {
        ...
        console.log("FILE DATA: " , this._fileData);
    ...
    outputFiles() {
        ...
        for (var i = 0; i < this._files.length; i++) {
            ...
            try {
                fs.mkdirSync(`${this._templateName}/${fileContent.destination}`);
            } catch(e) {}
            fs.writeFileSync(`${this._templateName}/${fileContent.destination}/${fileContent.name}`, ""+fileContent.content);
        }
        console.log("DONE");
    }
